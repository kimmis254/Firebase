package com.wayne.waynesapplication.ui.theme.screens.register
...
import com.wayne.waynesapplication.data.AuthViewModel
...
fun RegisterScreen(navController:NavHostController) {
    ...
    Column(modifier = Modifier
        ...
        Button(onClick = { navController.navigate(ROUTE_LOGIN) },
            ...
            Text(text = "Have an account? Click login")
